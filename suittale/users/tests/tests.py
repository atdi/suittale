...
from suittale.users.models import User, Role, Country, Region, City, Customer
...
class UserServiceTestCase(TestCase):
    def create_app(self):
        init_app('suittale.users.tests.config')
        return app
    ...
    def tearDown(self):
        os.remove(os.path.join(basedir, 'suittale.db'))
